...
<div class="row">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="nom" value="<?=$listes['nom'] ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Prenom</label>
    <input type="text" class="form-control" id="exampleInputPassword1" name="prenom" value="<?=$listes['prenom'] ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Age</label>
    <input type="number" class="form-control" id="exampleInputPassword1" name="age" value="<?=$listes['age'] ?>">
  </div>
  <div class="form-group">
    <label for="exampleInputPassword1">Listes de genre</label>
    <select name="genre" id="" class="form-control">
      <?php  foreach ($quette->result_array() as $list): ?>
      <option value=" <?=$list['code_genre'] ?> "><?=$list['genre'] ?></option>
      <?php endforeach;  ?>
    </select>
